...
| **5. Unity** | El exportador escribe `data/unity/semana04.json` y su copia en StreamingAssets. `VisorSemana04` lo lee una vez, en `Start` | `semana04/exportar_unity.py:711-717`; `VisorSemana04.cs:331`, `:343` | Registro del exe con el anexo `--cs 0.20`: columna 5 en S3 "Mn 1757.7 kN*m   u 0.296   PASA" y muro 9 en 1.2G+1.0Q+1.4EY "Mn 25605.2 kN*m   u 1.078   NO PASA", los mismos textos que emula `comparar_anexos.py` (ver abajo) |
...
- **Lectura de datos que sirve en Android y Web.** En esas plataformas
  ...
  `VisorSemana03.cs:341`, `VisorSemana04.cs:343`,
